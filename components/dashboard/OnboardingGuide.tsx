...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Vos clients reçoivent automatiquement une carte fidélité digitale. Ils cumulent des points et échangent des récompenses !',
    tips: [
      'Définissez le nombre de points par achat',
      'Créez des récompenses attractives (café offert, réduction...)',
      'Les clients reçoivent leur carte par WhatsApp',
    ],
