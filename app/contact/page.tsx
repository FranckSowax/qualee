      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-xl border-b border-gray-200/60 shadow-[0_1px_30px_rgba(0,0,0,0.04)]' : 'bg-white/60 backdrop-blur-md'}`}>
        <nav className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-8">
            {NAV.map(l => (
              <Link key={l.href} href={l.href} className="nav-link-underline text-sm font-medium text-gray-600 hover:text-teal-600 transition-colors">{l.label}</Link>
            ))}
          </div>
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/auth/signup" className="text-sm font-semibold px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-500 text-white hover:shadow-lg hover:shadow-teal-500/25 transition-all">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="p-12 rounded-2xl bg-white border border-gray-200 shadow-lg text-center">
                  ...
                  <Link href="/" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-500 text-white font-semibold hover:shadow-lg transition-all">
                ...
                <form onSubmit={handleSubmit} className="p-5 sm:p-8 md:p-10 rounded-2xl bg-white border border-gray-200 shadow-lg space-y-5 sm:space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-white transition-all"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-white transition-all resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-500 text-white font-semibold text-base hover:shadow-xl hover:shadow-teal-500/25 hover:-translate-y-0.5 transition-all disabled:opacity-60"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Features card */}
              <div className="p-8 rounded-2xl bg-[#0A1A14] text-white">
